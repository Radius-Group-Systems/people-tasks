    ...
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-[#252525]">
          <div className="w-4 h-4 rounded-full bg-[#91918B] animate-pulse" />
        </div>
      }
    >
      <LoginForm />
...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#252525] relative overflow-hidden">
      {/* Glow arc decorations — the signature Radius motif */}
      ...
      <RadiusGlowArc
        ...
        size={350}
        delay={400}
        className="!bottom-auto !right-auto top-[-120px] left-[-80px]"
      />
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <label
              htmlFor="email"
              className="text-xs font-medium text-[#91918B] uppercase tracking-widest"
            >
              Email
            </label>
            <input
        ...
        <p className="text-center text-sm text-[#6B6B66] mt-8">
          ...
          <Link
            href="/register"
            className="text-[#D6D3D1] hover:text-white transition-colors duration-150"
          >
            Sign up
          </Link>
        </p>
